...
with open("path_config.yaml", "r") as file:
    ...
    preprocessor_path = config["model_artifact"]["preprocessor_path"]
    general_preprocessor_path = config["model_artifact"]["general_preprocessor_path"]
...
class DataTransformation(BaseModel):
    ...
    def transform(
        ...
        try:
            ...
            # fix the name of the columns after transformation they contain the name of the transformer
            processed_train.columns = processed_train.columns.str.split("__").str[-1]
            processed_test.columns = processed_test.columns.str.split("__").str[-1]
